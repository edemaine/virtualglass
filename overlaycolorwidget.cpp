...
void OverlayColorWidget :: paintEvent(QPaintEvent*)
{
	QPainter painter;
	painter.begin(this);
        painter.fillRect(QRect(0, 0, 30, 30), QColor(0, 0, 0, 255));
        painter.fillRect(QRect(1, 1, 28, 28), QColor(255, 255, 255, 255));
	Color* c = (*(this->color));
        painter.fillRect(QRect(1, 1, 28, 28), QColor(255*c->r, 255*c->g, 255*c->b, 255*c->a));
        painter.end();
}
